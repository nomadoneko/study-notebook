...
function endDrawing(e, pageIndex) {
  ...
  if (currentStroke) {
    pages[currentStroke.pageIndex].push(currentStroke);
...
canvases.forEach((canvas, index) => {
  canvas.addEventListener("pointerdown", (e) => startDrawing(e, index));

  canvas.addEventListener("pointermove", (e) => draw(e, index));

  canvas.addEventListener("pointerup", (e) => endDrawing(e, index));
